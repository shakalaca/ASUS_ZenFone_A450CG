...
#ifdef CONFIG_A450CG
static int ar0543_raw_s_flash_mode(struct v4l2_subdev *sd, s32 value)
{
	printk("ar0543_raw_s_flash_mode\n");
...
static int ar0543_raw_s_flash_timeout(struct v4l2_subdev *sd, s32 value)
{
	//Do nothing now
	return 0;
}

static int ar0543_raw_s_flash_request(struct v4l2_subdev *sd, s32 value)
{
	printk("ar0543_raw_s_flash_request\n");
...
static int ar0543_raw_s_flash_intensity(struct v4l2_subdev *sd, s32 value)
{
	//Do nothing now
	return 0;
}

static int ar0543_raw_s_torch_intensity(struct v4l2_subdev *sd, s32 value)
{
	//Do nothing now
	return 0;
}

static int ar0543_raw_s_indicator_intensity(struct v4l2_subdev *sd, s32 value)
{
	//Do nothing now
	return 0;
}
...
static struct ar0543_raw_control ar0543_raw_controls[] = {
	...
	},
	{
		...
		.tweak = ar0543_raw_s_flash_timeout,
	},
	{
		.qc = {
		...
		.tweak = ar0543_raw_s_flash_request,
	},
	{
		.qc = {
		...
		.tweak = ar0543_raw_s_flash_intensity,
	},
	{
		.qc = {
		...
		.tweak = ar0543_raw_s_torch_intensity,
	},
	{
		.qc = {
		...
		.tweak = ar0543_raw_s_indicator_intensity,
	},
#endif
};
			 ...
			 const struct i2c_device_id *id)
{
	...
	create_camera_proc_file(); //For DIT VCM Debug Interface+++
