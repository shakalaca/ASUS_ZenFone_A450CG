...
void EXISP_I2C_VendreqCmdSet(void);
...
//UINT8 EXISP_SPIDataWrite(UINT8 ucSPIMode, UINT8 ucSPIFreq, UINT8 *ucStartAddr, UINT32 ulTransByteCnt, UINT32 ulDmaAddr);
//UINT8 EXISP_7002SPICfg(UINT8 ucSPIMode, UINT8 ucSPIFreq, UINT32 ulDmaAddr, UINT32 ulTransByteCnt);
