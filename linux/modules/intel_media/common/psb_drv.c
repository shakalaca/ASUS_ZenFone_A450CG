...
#include "mdfld_dsi_dpi.h"
#elif ASUS_PROJECT_A450CG_DISPLAY
#include "mdfld_dsi_dpi.h"
#endif
...
#ifdef CONFIG_SUPPORT_A450CG_MIPI_OTM8018B_DISPLAY
extern struct platform_driver a450cg_otm8018b_vid_lcd_driver;
#endif
...
#ifdef CONFIG_SUPPORT_MIPI_B080EAN020_DISPLAY
extern struct platform_driver b080ean020_vid_lcd_driver;
#endif
...
#if defined(CONFIG_SUPPORT_DDS_MIPI_SWITCH) || defined(ASUS_PROJECT_A450CG_DISPLAY)
		if (arg->vsync_operation_mask & VSYNC_RESET_PANEL) {
			printk("vsync timeout reset panel\n");
...
#ifdef CONFIG_SUPPORT_A450CG_MIPI_OTM8018B_DISPLAY
	ret = platform_driver_register(&a450cg_otm8018b_vid_lcd_driver);
#endif
...
#ifdef CONFIG_SUPPORT_MIPI_B080EAN020_DISPLAY
	ret = platform_driver_register(&b080ean020_vid_lcd_driver);
#endif
