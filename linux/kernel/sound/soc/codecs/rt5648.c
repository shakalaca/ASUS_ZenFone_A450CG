...
static DEVICE_ATTR(index_reg, 0666, rt5648_index_show, rt5648_index_store);
...
static DEVICE_ATTR(codec_reg, 0666, rt5648_codec_show, rt5648_codec_store);
			...
			enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_OFF:
		...
		snd_soc_write(codec, RT5648_DIG_MISC, 0x0120);
