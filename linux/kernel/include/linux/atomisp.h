...
//ASUS_BSP+++
#define CUSTOM_IOCTL_REG_SET	(V4L2_CID_CAMERA_LASTP1 + 26)	//for calibration
#define CUSTOM_IOCTL_REG_GET	(V4L2_CID_CAMERA_LASTP1 + 27)	//for calibration
#define CUSTOM_IOCTL_SPI_GET	(V4L2_CID_CAMERA_LASTP1 + 28)	//for calibration
#define V4L2_CID_EFFECT_AURA	(V4L2_CID_CAMERA_LASTP1 + 29)
#define V4L2_CID_WDR		(V4L2_CID_CAMERA_LASTP1 + 30)
#define V4L2_CID_EDGE		(V4L2_CID_CAMERA_LASTP1 + 31)	//for Best shot
#define V4L2_CID_3A_LOCK_ISP	(V4L2_CID_CAMERA_LASTP1 + 32)
#define V4L2_CID_PRIVIEW_EXPOSURE_TIME	(V4L2_CID_CAMERA_LASTP1 + 33)
#define V4L2_CID_HDR		(V4L2_CID_CAMERA_LASTP1 + 34)
#define V4L2_CID_Y_INFO		(V4L2_CID_CAMERA_LASTP1 + 35)
#define V4L2_CID_ROI_TRIGGER	(V4L2_CID_CAMERA_LASTP1 + 36)
#define V4L2_CID_AF_WINDOW	(V4L2_CID_CAMERA_LASTP1 + 37)
#define V4L2_CID_AF_RESULT	(V4L2_CID_CAMERA_LASTP1 + 38)
#define V4L2_CID_ICATCH_3A_AE1	(V4L2_CID_CAMERA_LASTP1 + 39)
#define V4L2_CID_ICATCH_3A_AE2	(V4L2_CID_CAMERA_LASTP1 + 40)
#define V4L2_CID_ICATCH_3A_AWB1	(V4L2_CID_CAMERA_LASTP1 + 41)
#define V4L2_CID_ICATCH_3A_AWB2	(V4L2_CID_CAMERA_LASTP1 + 42)
#define V4L2_CID_ICATCH_3A_AF1	(V4L2_CID_CAMERA_LASTP1 + 43)
#define V4L2_CID_ICATCH_3A_AF2	(V4L2_CID_CAMERA_LASTP1 + 44)
#define V4L2_CID_HILIGHT_MODE	(V4L2_CID_CAMERA_LASTP1 + 45)
//ASUS_BSP---
...
//ASUS_BSP+++
	V4L2_COLORFX_AURA = 1003,
	V4L2_COLORFX_VINTAGE = 1004,
	V4L2_COLORFX_VINTAGE2 = 1005,
	V4L2_COLORFX_LOMO = 1006,
	V4L2_COLORFX_RED = 1007,
	V4L2_COLORFX_BLUE = 1008,
	V4L2_COLORFX_GREEN = 1009,
//ASUS_BSP---
};
